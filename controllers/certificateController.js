...
const certificationController = {
  ...
  // Get all certifications (without populating form templates for better performance)
  getAllCertifications: async (req, res) => {
    try {
      // Get all active certifications with required fields (no populate for speed)
      ...
      // Filter out any certifications that might have missing critical fields
  ...
  // Get certification form template IDs only (optimized for speed)
