...
router.post("/", authenticate, validateRTOAccess, authorize("admin", "super_admin", "certified-admin"), formTemplateController.createFormTemplate);
router.put("/:id", authenticate, validateRTOAccess, authorize("admin", "super_admin", "certified-admin"), formTemplateController.updateFormTemplate);
router.delete("/:id", authenticate, validateRTOAccess, authorize("admin", "super_admin", "certified-admin"), formTemplateController.deleteFormTemplate);
