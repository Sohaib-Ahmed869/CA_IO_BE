...
router.post("/:id/reschedule-approve", authenticate, authorize("admin", "assessor"), bookingController.approveReschedule);
router.post("/:id/reschedule-reject", authenticate, authorize("admin", "assessor"), bookingController.rejectReschedule);
